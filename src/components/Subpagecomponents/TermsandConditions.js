...
import styles from "../../styles/Subpagecomponents/TermsandConditions.module.scss"
    ...
    <div className={styles.modal}>
      <div className={styles.detailsModel}>
        <div className={styles.modaltopbar}>
          ...
          <a className={styles.closebutton} value={false} onClick={() => props.updatetc()}>close</a>
        </div>
        <div className={styles.modalcontent}>
    
          <h2>Last Updated 06 December 2022</h2>
          <p>Your privacy is important to us. It is Eurolinks policy to respect your privacy and comply with any applicable law and regulation regarding any personal information we may collect about you, including across our website, <a href="https://lukeobrien.dev/">https://Eurolink.comv/</a>, and other sites we own and operate. </p>
          <p>This policy is effective as of 6 December 2022 and was last updated on 6 December 2022. </p>
